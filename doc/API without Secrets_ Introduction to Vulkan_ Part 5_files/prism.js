...
(function () {
    ...
    var _resizeElement = function (element) {
        ...
        if (whiteSpace === 'pre-wrap' || whiteSpace === 'pre-line') {
            ...
            var codeLines = codeElement.textContent.trim().split(NEW_LINE_EXP);
            if (!lineNumberSizer) {
    ...
    Prism.hooks.add('complete', function (env) {
        ...
        var match = env.code.trim().match(NEW_LINE_EXP);
...
(function(){
    ...
    var hook = Prism.plugins.toolbar.hook = function (env) {
        ...
        // Setup the toolbar at right side
        ...
        //Add copy code toolbar before code snippet's <code> tag content ie <pre.firstChild>
...
(function(){
    ...
    if (!ClipboardJS) {
        ...
        script.src = 'https://web.archive.org/web/20200916134917/https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.0/clipboard.min.js';
...
/*
     FILE ARCHIVED ON 13:49:17 Sep 16, 2020 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 21:53:58 Sep 10, 2025.
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 8.265
  LoadShardBlock: 174.211 (3)
  PetaboxLoader3.datanode: 151.062 (4)
  PetaboxLoader3.resolve: 521.76 (2)
  load_resource: 519.115
*/