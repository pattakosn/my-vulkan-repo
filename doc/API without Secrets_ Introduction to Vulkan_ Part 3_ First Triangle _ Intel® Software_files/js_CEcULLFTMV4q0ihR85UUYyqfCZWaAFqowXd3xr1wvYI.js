      ...
      $('.block-search .form-item-search-block-form input.form-text, .gss .form-item-keys input.form-text, .block-search .form-search input.form-text')
        ...
        .autocomplete({
          ...
          source: function (request, response) {
            $.ajax({
              url: "https://web.archive.org/web/20200502214029/https://clients1.google.com/complete/search?q=" + request.term + "&hl=en&client=partner&source=gcsc&partnerid=" + settings.gss.key + "&ds=cse&nocache=" + Math.random().toString(),
              dataType: "jsonp",
...
/*
     ...
     INTERNET ARCHIVE ON 21:53:10 Sep 10, 2025.
...
playback timings (ms):
  ...
  esindex: 0.012
  cdx.remote: 12.621
  LoadShardBlock: 406.197 (3)
  PetaboxLoader3.datanode: 194.234 (5)
  PetaboxLoader3.resolve: 172.291 (2)
  load_resource: 140.052 (2)
*/